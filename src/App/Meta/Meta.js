...
const Meta = () =>
    <div className="meta">
        ...
        <div className="meta_grid_container">
            ...
            <Rechts>
                Je krijgt <b className='blauw'>altijd antwoord</b> waar je je antwoord hebt ingestuurd. Stuur je in via DM, dan krijg je een DM terug. Op de website krijg je antwoord onder het invulding.<br/>
                Als je alleen de titel of alleen de artiest goed hebt, hoef je die daarna niet meer in je antwoord te zetten. Het antwoordapparaat onthoudt dat wel.
            </Rechts>
            <Links>
                <i className="fa-solid fa-users-gear"/>
            </Links>
            <Rechts>
                Log je in met een <b className='blauw'>ander account</b> dan waarmee je eerder hebt gespeeld? Heb je bijvoorbeeld eerder met Twitter antwoorden ingestuurd, maar gebruik je nu een Google- of een Mastodonaccount?<br/>
            ...
            <Rechts>
                Je kan <b className='blauw'>niets winnen</b>, het gaat enkel om de eer. Wel kun je met bepaalde prestaties in de
            ...
            <Rechts>
                ...
                Ik zit op Twitter onder gebruikersnaam <a href="https://twitter.com/videoclipquiz" target="_new">@videoclipquiz</a>.
                <br/>
                Op Mastodon kun je me vinden op <a rel="me" href="https://mastodon.nl/@videoclipquiz">@videoclipquiz@mastodon.nl</a>.<br/>
            </Rechts>
            <Links>
                <i className="fa-regular fa-thumbs-up"/>
            </Links>
            <Rechts>
                Vind je de quiz leuk? Je kan me <b className='blauw'>bedanken</b> met een kleine tegemoetkoming in de serverkosten.<br/>
            ...
            <Rechts>
                De <b className='blauw'>videoclipgifquiz</b> is een vervolg van de <a href="https://outroquiz.nl"
                                                                    target="_new">outroquiz</a>, die gedurende de jaren
            ...
            <Rechts>
                Deze quiz is een <b className='blauw'>hobbyproject</b> en volledig <i>from scratch</i> geschreven en geprogrammeerd. De
            ...
            <Rechts>
                Ik ben <b className='blauw'>Wouter</b>, bouwjaar 1976. Ik woon in Groningen, heb drie zoons en ben treindienstleider. In
            ...
            <Rechts>
                ...
                <ul>
                    ...
                    <li><a href="https://blekejet.nl" target="_new">blekejet</a>, gewijd aan het iconische nummer <b className='blauw'>Achter
